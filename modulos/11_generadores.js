...
const moduloGeneradores = {
    ...
    inicio: {
        pregunta_es: "ESTACIÓN 1 - CUMMINS ONAN QG (2800/4000/5500/7000 GASOLINA / LP):\n" +
            "¿El motor auxiliar de combustión presenta fallas críticas de arranque o retención?\n" +
        ...
        aislamiento_es: "GUÍA TÉCNICA PASO A PASO PARA REFORZAR EL DIAGNÓSTICO EN TALLER (SOLUCIÓN DE EXPLICACIÓN PRÁCTICA):\n" +
            ...
            "3. Abre la tapa lateral del estator and mide el conjunto de escobillas de carbón y anillos colectores (Slip Rings): la lectura de resistencia con tu multímetro calibrado debe marcar entre 20 y 25 Ohmios estables; parámetros que marquen resistencia infinita confirman un circuito abierto destructivo en las bobinas del rotor.\n" +
        ...
        si: "pregunta2", // Enlace lineal directo continuo hacia la línea pesada Quiet Diesel
        no: "pregunta2"
    },
    ...
    pregunta2: {
        ...
        si: "pregunta3", // Enlace lineal indexado nativo hacia la estación de Generac
        no: "pregunta3"
    },
...
function cargarPreguntasGeneradores() {
    ...
    if (typeof moduloGeneradores !== 'undefined') {
        ...
        nodoActual = "inicio"; // Inicializa de forma lineal en la primera estación de Onan QG
